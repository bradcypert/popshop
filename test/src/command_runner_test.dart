...
void main() {
  group('PopshopCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late PopshopCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = PopshopCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = PopshopCommandRunner();
    ...
    group('--verbose', () {
      ...
      test('enables verbose logging for help command', () async {
